...
TAGS_METADATA = [
    ...
    {
        "name": "ESP",
        "description": "Routes to get information from ESP",
        "externalDocs": {
            "description": "ESP Documentation",
            "url": "https://documenter.getpostman.com/view/1296288/UzQuNk3E",
        }
    },
]
...
app = FastAPI(
    title="ESP Discord Bot API",
    description="API for Eskom se Push discord bot.",
    version="0.0.1",
